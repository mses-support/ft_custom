    ...
    def _onchange_employee_id(self):
        ...
        if self.employee_id.id:
            ...
            contract_ids = self.env['hr.version'].search(
                [('employee_id', '=', self.employee_id.id)])
            contract_sorted = contract_ids.sorted(lambda line: line.contract_date_start or fields.Date.today())
            ...
            if hr_contract_id.contract_date_end:
                self.employee_contract_type = 'limited'
                employee_working_days = (
                        hr_contract_id.contract_date_end - joining_date).days
