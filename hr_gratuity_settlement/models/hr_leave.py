...
class HrLeave(models.Model):
    """Inherits hr.leave to extend leave validation functionality. This
        ensures that leaves taken during the probation period are recorded
        and can extend the probation period based on the type and duration
        of leave."""
    _inherit = 'hr.leave'
