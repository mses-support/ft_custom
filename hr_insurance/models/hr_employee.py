...
class HrEmployee(models.Model):
    ...
    @api.depends('insurance_ids.date_from', 'insurance_ids.date_to',
                 'insurance_ids.policy_coverage', 'insurance_ids.amount',
    ...
    def _compute_deducted_amount(self):
        ...
        for emp in self:
            ...
            for ins in emp.insurance_ids:
                if ins.date_from and ins.date_from <= current_date:
                    if ins.date_to and ins.date_to >= current_date:
